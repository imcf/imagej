...
public class MeasureService {
	...
	private class Computation<T> {
		...
		public boolean isResolved() { return value != null; }
	...
	private class Count extends Computation<LongType> {
		...
		public void compute() {
			value = new LongType(region.size()); // TODO : make it a SamplingMeasure instead
		}
		
		public LongType getValue() { return value; }
	}
	...
	private class Sum extends Computation<DoubleType> {
		...
		public DoubleType getValue() { return value; }
	}
	...
	private class ConvexHull extends Computation<PointSet> {
		...
		public PointSet getValue() { return value; }
	}
